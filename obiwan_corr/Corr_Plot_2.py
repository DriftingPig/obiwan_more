...
filename = 'BinHist'
filedir = '/global/cscratch1/sd/huikong/obiwan_data/data_from_obiwantest/obiwan_test/obiwan_corr/data/BinHist/uniform_obiwan_NGC/'
...
def CorrFunc(Njob=Njob,k0=1, order=0,name_corr = filename):
    ...
    np.savetxt('/global/cscratch1/sd/huikong/obiwan_data/data_from_obiwantest/obiwan_test/obiwan_corr/data/rawdata/corrfunc_data/uniform_obiwan_NGC.out',zip(x,Final_total,CorrFunc_Err))
