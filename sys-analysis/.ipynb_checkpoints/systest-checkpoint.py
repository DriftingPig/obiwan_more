...
def Obiwansys(surveyname,map_name='ext',sysmax=0.13,sysmin=0.01,res=256,nest = False,dataset = 'obiwan',xlab = ''):
    ...
    fs.close()
    print "test4"
    plot_exct(outputname,"./plots/"+map_name+"_"+dataset+".pdf",'eBoss sgc '+dataset,xlab = xlab)
    return True
...
'''
Obiwansys(eboss,'hpstardens',sysmax=2400,sysmin=900,dataset = 'uniform',xlab='star density')
Obiwansys(eboss,'hpstardens',sysmax=2400,sysmin=900,dataset = 'obiwan',xlab='star density')
'''
